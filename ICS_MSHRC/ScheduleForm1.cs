...
namespace ICS_MSHRC
{
    public partial class ScheduleForm1 : Form
    {
        private DataGridView Table;
        private int Id;
        public ScheduleForm1(string type, DataGridView table)
        {
            InitializeComponent();
            this.Text = type;
            confirm.Text = type;
        ...
        public ScheduleForm1(string type, DataGridView table, DBProvider.Schedule schedule, int id)
        {
            InitializeComponent();
            this.Text = type;
            confirm.Text = type;
